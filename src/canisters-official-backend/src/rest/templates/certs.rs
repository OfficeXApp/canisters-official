// src/rest/templates/certs.rs
use crate::{
         rest::templates::route::TEMPLATES_LIST_PATH,
         types::*,
         TEMPLATE_ITEMS,
     };
    ...
    use ic_http_certification::{
     ...
     lazy_static! {
         pub static ref TEMPLATES_TREE_PATH: HttpCertificationPath<'static> = HttpCertificationPath::exact(TEMPLATES_LIST_PATH);
    ...
    pub fn certify_not_allowed_templates_responses() {
         [
             Method::HEAD,
             Method::PUT,
             Method::PATCH,
