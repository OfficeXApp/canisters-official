...
pub const DRIVES_SNAPSHOT_PATH: &str =              genroute!("/canister/snapshot");
pub const DRIVES_REPLAY_PATH: &str =                genroute!("/canister/replay");
pub const DRIVES_SEARCH_PATH: &str =                genroute!("/canister/search");
pub const DRIVES_REINDEX_PATH: &str =               genroute!("/canister/reindex");
pub const DRIVES_EXTERNAL_ID_PATH: &str =           genroute!("/canister/external_id");
pub const DRIVES_TRANSFER_OWNERSHIP_PATH: &str =    genroute!("/canister/transfer_ownership");
