            ...
            match req {
                UpsertTeamRequestBody::Create(create_req) => {
                    ...
                    let new_team = Team {
                        ...
                        drive_id: DriveID(PublicKeyBLS(ic_cdk::api::id().to_text())),
                    };
