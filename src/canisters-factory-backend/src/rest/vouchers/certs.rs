...
use crate::rest::vouchers::route::VOUCHERS_LIST_PATH;
...
lazy_static! {
    pub static ref APIKEYS_TREE_PATH: HttpCertificationPath<'static> = HttpCertificationPath::exact(VOUCHERS_LIST_PATH);
