...
use crate::rest::giftcards_spawnorg::route::GIFTCARDS_SPAWNORG_LIST_PATH;
...
lazy_static! {
    pub static ref APIKEYS_TREE_PATH: HttpCertificationPath<'static> = HttpCertificationPath::exact(GIFTCARDS_SPAWNORG_LIST_PATH);
